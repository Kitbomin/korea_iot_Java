...
public class C_Anonymous {
    public static void main(String[] args) {
        ...
        Student student2 = new Student("나나나", 95);
        Student student3 = new Student("마마마", 20);
        Student student4 = new Student("사사사", 85);
        Student student5 = new Student("차차차", 70);
