...
public class F_Practice {
    public static void main(String[] args) {
        ...
        while (isRun) {
            ...
            switch (selectedMenu){
                case "1":
                    System.out.println("회원등록 기능입니다.");
                    break;

                case "2" :
                    System.out.println("회원조회 기능입니다.");
                ...
                default:
                    System.out.println("잘못된 입력입니다. 다시 입력하셔요");
